...
static void *aligned_realloc_checked(void *ptr, const size_t old_size, const size_t new_size) {
...
#define ARRAY_RESERVE(arr, cap)                                                                    \
    do {                                                                                           \
        if ((cap) > (arr).capacity) {                                                              \
            ...
            void *_new_data =                                                                      \
                aligned_realloc_checked((arr).data, _old_cap * _elem_size, _new_cap * _elem_size); \
            (arr).data = _new_data;                                                                \
...
typedef enum AlphaMode { ALPHA_MODE_OPAQUE, ALPHA_MODE_MASK, ALPHA_MODE_BLEND } AlphaMode;
